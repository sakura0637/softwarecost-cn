...
export const DATA_TABLES: DataTableConf[] = [
  ...
  },
  {
    ...
    hint:
      ...
      '【数字出处】照抄源表《定额》页（单价汇总表），主流形态是「(原始定额 ÷ 12个月) × 运维单价调整系数」：' +
      '· 原始定额 = 2008 年行业维护定额（元/年），如 1200、115、48、96、280+120×n；' +
      '· ÷12 = 年额折月额；' +
      '· 运维单价调整系数 = 136833 ÷ 39340 = 3.4782 —— 把 2008 年定额折算到 2025 年价。' +
      '  39340 / 136833 分别是河北省信息技术行业城镇平均工资 2008 年 / 2025 年（元/年，源表《定额》I5 原注）。' +
      '【特殊形态】· UPS 类：「(280 + 120×扩展单元数) ÷ 12 + 96×电池块数 ÷ 12」，再各乘调整系数（280 基础、' +
      '120 每扩展单元、96 每块蓄电池）。' +
      '· 按功能点计价的 PLC应用系统 / UNITY PRO：「月工资基数 11402.75 ÷ 176工时 × 功能点系数 0.1」，' +
      '  176 = 8小时 × 22工作日 = 月工时（源表《定额》I11 原注「一个功能点每月（8*22）」）。',
  },
  {
